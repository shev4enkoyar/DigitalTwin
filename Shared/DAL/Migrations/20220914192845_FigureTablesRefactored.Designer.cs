...
namespace DAL.Migrations
{
    ...
    [Migration("20220914192845_FigureTablesRefactored")]
    partial class FigureTablesRefactored
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.FigureType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DAL.Models.DigitalModel", b =>
                {
                    b.HasOne("DAL.Models.Map", "Map")
                        .WithOne("DigitalModel")
                        .HasForeignKey("DAL.Models.DigitalModel", "MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.FigureCategory", b =>
                {
                    ...
                    b.HasOne("DAL.Models.FigureType", "FigureType")
                        .WithMany("FigureCategories")
