...
const FieldCard = (props) => {
    return (
        <BaseCard visible={props.visible} off={props.statusOff} hText="Статус модели" descr="Требуется добавить данные о поле!" notifyColor="#DC3545" isBut={<Button className="blueBut ButAllMini"/>}>
