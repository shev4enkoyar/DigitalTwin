    ...
    return (
        <>
            <ThemeContextConsumer>
                {
                    context => (
                        <Container className={context.theme + (props.progress ? "progressStep " : context.theme === "light" ? "lightStep":"") + " px-1 m-0 d-flex justify-content-center align-items-center"} style={{ minHeight: '55px', width: 'calc(100%/6)', height: '100%' }}>
